...
This means one can have an always-on privatedivid instance running, and another local privatedivid/divi-qt instance which connects to this node and receives blocks from it.
